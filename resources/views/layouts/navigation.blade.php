        ...
        <div class="flex items-start space-x-2">
            @auth
                ...
                <a href="{{ route('admin.categories.index') }}" class="flex items-center">
                    <img src="{{ asset('images/logo-komdigi.png') }}" alt="Komdigi" class="h-8 w-auto" />
        ...
        <div class="flex items-center space-x-4">
            @auth
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="flex items-center text-sm font-medium text-white hover:text-primary-light focus:outline-none transition">
